...
export function CareerCTA({ settings }: { settings?: Record<string, string> }) {
  return (
    <Section id="career" className="py-32 relative overflow-hidden bg-zinc-950 text-white">
      ...
      />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-250 h-125 bg-primary/20 blur-[120px] rounded-full pointer-events-none z-0 opacity-40" />
            ...
            >
               ...
               <h2 className="text-5xl md:text-7xl font-bold tracking-tight mb-8">
                  {settings?.career_title || (
                    <>Become a <br className="hidden md:block" /><span className="bg-clip-text text-transparent bg-linear-to-r from-white to-white/60">Digital Pioneer</span></>
                  )}
               </h2>
               
               <p className="text-xl text-zinc-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                  {settings?.career_description || "Join a team where your code impacts millions. We offer a culture of freedom, mastery, and purpose."}
               </p>
