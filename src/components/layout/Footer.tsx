...
export function Footer({ settings }: FooterProps) {
   const tagline = settings?.footer_tagline || "Empowering businesses through digital transformation. We build scalable, high-performance solutions for the modern world."
   const companyName = settings?.footer_company_name || "Ucentric Inc."
   const newsletterText = settings?.footer_newsletter_text || "Subscribe to our newsletter for the latest insights."
   const linkedinUrl = settings?.footer_social_linkedin || "#"
   const twitterUrl = settings?.footer_social_twitter || "#"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
               ...
               <div className="space-y-4">
                  ...
                  <div className="flex gap-4 pt-4">
                     <SocialLink icon={<Linkedin className="w-4 h-4" />} href={linkedinUrl} />
                     <SocialLink icon={<Twitter className="w-4 h-4" />} href={twitterUrl} />
                     <SocialLink icon={<Instagram className="w-4 h-4" />} href={instagramUrl} />
                     <SocialLink icon={<Facebook className="w-4 h-4" />} href={facebookUrl} />
                  </div>
               </div>
